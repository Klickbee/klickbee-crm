      ...
      <div className="px-4 py-4 flex flex-col gap-4 ">
        ...
        <FieldBlock name="dueDate" label="Due Date" error={errors.dueDate?.message}>
          <Controller
            ...
            render={({ field }) => (
              <CalendarDropDown
                label={field.value ? new Date(field.value).toLocaleDateString("en-US", { month: "long", day: "numeric", year: "numeric" }) : "Select due Date"}
        ...
        <UploadButton values={getValues("files") || []} setValue={(values) => setValue("files", values, { shouldValidate: true })} uploading={uploading} uploadFile={(e) => handleFileChange(e)} />
      </div>
